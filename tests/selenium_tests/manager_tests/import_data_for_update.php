...
class ImportDataForUpdateTest extends LOVDSeleniumWebdriverBaseTestCase
{
    ...
    public function test ()
    {
        ...
        $this->enterValue('import', ROOT_PATH . '../tests/test_data_files/ImportUpdate.txt');
        $this->selectValue('mode', 'Update existing data (in beta)');
        $this->submitForm('Import file');

        $this->assertEquals("Done importing!\n" .
            'The following sections are modified and updated in the database: ' .
            'Columns, Diseases, Individuals, Phenotypes, Screenings, Variants_On_Genome, Variants_On_Transcripts.',
