...
class PostFinishAddVariantLocatedWithinGeneToCMTTest extends LOVDSeleniumWebdriverBaseTestCase
{
...
//        $element = $this->driver->findElement(WebDriverBy::cssSelector("#0000000002 > td.ordered"));
        ...
        $GenomicDnaChange = $this->driver->executeScript("return window.document.getElementById('variantForm').elements[9].value");
