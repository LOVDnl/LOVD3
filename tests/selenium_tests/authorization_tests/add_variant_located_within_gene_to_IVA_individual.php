...
class AddVariantLocatedWithinGeneToIVAIndividualTest extends LOVDSeleniumBaseTestCase
{
    public function testAddVariantLocatedWithinGeneToIVAIndividual()
    {
        $this->open(ROOT_URL . "/src/variants?create&reference=Transcript&geneid=IVD&target=0000000001");
