        ...
        if ($sView == 'entry') {
            ...
            if (isset($this->aColumnsViewEntry['license_'])) {
                if (empty($zData['license'])) {
                    ...
                    $nIndividualID = (
                        $this->sObject == 'Individual'? $zData['id'] : (
                            in_array($this->sObject, array('Phenotype', 'Screening'))? $zData['individualid'] : false
                        )
                    );

                    if (strpos($zData['license'], ';') !== false) {
                        ...
                        if ($this->sObject == 'Genome_Variant' && count($zData['individuals']) > 1) {
