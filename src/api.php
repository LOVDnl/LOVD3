...
if ($sDataType == 'variants') {
    foreach ($aData as $zData) {
        ...
        $zData['created_by']   = $zData['created_by_'];
        $sContributors         = $zData['owned_by_'];
