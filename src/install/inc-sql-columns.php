...
//                'INSERT INTO ' . TABLE_COLS . ' VALUES ("Individual/Mutation/Origin",           0, 200, 0, 0, 0, "Mut. origin",          "", "Origin of mutation", "Origin of mutation", "VARCHAR(9)", "Origin of mutation||select|1|Unknown|false|false", "De novo\r\nInherited", "", 1, 1, 1, 1, NOW(), NULL, NULL)',
                ...
                'INSERT INTO ' . TABLE_COLS . ' VALUES ("VariantOnGenome/DBID",                 6, 200, 1, 1, 1, "DB-ID",                "This ID is used to group multiple instances of the same variant together. The ID starts with the gene symbol of the transcript most influenced by the variant or otherwise the closest gene, followed by an underscore (_) and the ID code, which consists of six digits.", "Database IDentifier.", "Database IDentifier, grouping multiple instances of the same variant together.", "VARCHAR(50)", "ID||text|15", "", "/^[A-Z][A-Z0-9]+_[0-9]{6}\\\\b/", 1, 0, 1, 1, NOW(), NULL, NULL)',
