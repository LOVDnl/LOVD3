...
// Variant types (protein level), whole database, pathogenic.
...
// Variant positions, whole database.
...
$_G->variantsTypeProtein('variantsTypeProtein_unique_pathogenic', '*', ($_AUTH['level'] >= LEVEL_COLLABORATOR), true, true);
$_G->variantsPositions('variantsPositions', '*', ($_AUTH['level'] >= LEVEL_COLLABORATOR));
//end_david
