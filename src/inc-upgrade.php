...
if ($sCalcVersionFiles != $sCalcVersionDB) {
    ...
    $aUpdates =
             ...
             'allele_values' => 'Reserved for the insert query of the new allele table. This will be added later in this script.',
                 ...
                 '3.0-18b' =>
                    array(
                        'ALTER TABLE ' . TABLE_USERS . ' ALTER department SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_USERS . ' ALTER telephone SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_USERS . ' ALTER reference SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_USERS . ' ALTER password_force_change SET DEFAULT 0;',
                        ...
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER refseq_UD SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER reference SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER url_homepage SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_GENES . ' MODIFY url_external TEXT;',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER allow_download SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER allow_index_wiki SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER show_hgmd SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER show_genecards SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER show_genetests SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_GENES . ' MODIFY note_index TEXT;',
                        'ALTER TABLE ' . TABLE_GENES . ' MODIFY note_listing TEXT;',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER refseq SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER refseq_url SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_GENES . ' ALTER disclaimer SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_GENES . ' MODIFY disclaimer_text TEXT;',
                        'ALTER TABLE ' . TABLE_GENES . ' MODIFY header TEXT;',
                        ...
                        'ALTER TABLE ' . TABLE_TRANSCRIPTS . ' ALTER id_ncbi SET DEFAULT \'\';',
                        ...
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER standard SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER mandatory SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER head_column SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_COLS . ' MODIFY form_type TEXT;',
                        'ALTER TABLE ' . TABLE_COLS . ' MODIFY description_form TEXT;',
                        'ALTER TABLE ' . TABLE_COLS . ' MODIFY description_legend_short TEXT;',
                        'ALTER TABLE ' . TABLE_COLS . ' MODIFY description_legend_full TEXT;',
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER mysql_type SET DEFAULT \'TEXT\';',
                        'ALTER TABLE ' . TABLE_COLS . ' MODIFY select_options TEXT;',
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER preg_pattern SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER public_view SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER public_add SET DEFAULT 0;',
                        ...
                        'ALTER TABLE ' . TABLE_SHARED_COLS . ' ALTER public_view SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_SHARED_COLS . ' ALTER public_add SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_SHARED_COLS . ' MODIFY description_form TEXT;',
                        ...
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER email_address SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER send_admin_submissions SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER api_feed_history SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER refseq_build SET DEFAULT \'hg38\';',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER proxy_host SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER proxy_username SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER proxy_password SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER omim_apikey SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER send_stats SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER include_in_listing SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER lock_users SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER allow_unlock_accounts SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER allow_submitter_mods SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER allow_count_hidden_entries SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER use_ssl SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER use_versioning SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER lock_uninstall SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_STATUS . ' ALTER lock_update SET DEFAULT 0;',
                        'ALTER TABLE ' . TABLE_STATUS . ' ALTER version SET DEFAULT \'3.0-18b\';',
                        'ALTER TABLE ' . TABLE_STATUS . ' ALTER signature SET DEFAULT \'\';',
                        'ALTER TABLE ' . TABLE_STATUS . ' ALTER installed_date SET DEFAULT \'1000-01-01\';',
                        'ALTER TABLE ' . TABLE_ANNOUNCEMENTS . ' ALTER start_date SET DEFAULT \'1000-01-01 00:00:00\';',
                        ...
                        'ALTER TABLE ' . TABLE_MODULES . ' ALTER installed_date SET DEFAULT \'1000-01-01\';',
