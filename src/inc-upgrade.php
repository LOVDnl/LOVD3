             ...
             'allele_values' => 'Reserved for the insert query of the new allele table. This will be added later in this script.',
                 ...
                 '3.0-18b' =>
                    array(
                        ...
                        'ALTER TABLE ' . TABLE_COLS . ' ALTER mysql_type SET DEFAULT "VARCHAR(50)";',
                        ...
                        'ALTER TABLE ' . TABLE_SHARED_COLS . ' ALTER public_view SET DEFAULT 1;',
                        'ALTER TABLE ' . TABLE_SHARED_COLS . ' ALTER public_add SET DEFAULT 1;',
                        ...
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER send_stats SET DEFAULT 1;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER include_in_listing SET DEFAULT 1;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER lock_users SET DEFAULT 1;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER allow_unlock_accounts SET DEFAULT 1;',
                        'ALTER TABLE ' . TABLE_CONFIG . ' ALTER allow_submitter_mods SET DEFAULT 1;',
