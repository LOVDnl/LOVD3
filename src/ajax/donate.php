...
if (!$("#donate_dialog").length) {
    $("body").append("<DIV id='donate_dialog' title='Donate to the LOVD project'>Dear user,<BR><BR>The LOVD software that runs this database is provided free of charge to the scientific community. However, creating and maintaining it as well as keeping the servers running that host the software and the central GV shared LOVD instance, is not free.<BR>Please consider making a donation to support us, through a donation to Global Variome / The Human Variome Project.<IMG src='gfx/donate_qr_100x100.png' alt='' width='100' height='100' style='float: right;'><BR><BR>Thank you in advance for your support!<BR>The LOVD team, Leiden, Netherlands<BR><BR><A href='https://www.paypal.com/donate/?hosted_button_id=DHJVLF3Z2TA2U' target='_blank'><IMG src='https://www.paypalobjects.com/en_GB/i/btn/btn_donate_LG.gif' border='0' title='PayPal - The safer, easier way to pay online!' alt='Donate with PayPal button'></A></DIV>");
}
