...
For details on all fields, see section ``\hyperlink{ssec:announcements_create}{\nameref{ssec:announcements_create}}''.
...
The format used by the submission API is a JSON implementation of the \hyperlink{http://varioml.org/}{VarioML format}.
...
The `\texttt{@id}' is the LOVD's ID, which can be found by
 the database administrator in the API authorization token dialog
 (see ``\hyperlink{ssec:getting_your_auth_token}{\nameref{ssec:getting_your_auth_token}}''.
If you do not know who the LOVD's administrator is, submit the file without a valid ID
 (see ``\hyperlink{ssec:submitting_the_json_file}{\nameref{ssec:submitting_the_json_file}}'')
 and LOVD will respond with the administrator's contact information.
\vskip \baselineskip
...
\hypertarget{ssec:getting_your_auth_token}{}
...
\hypertarget{ssec:submitting_the_json_file}{}
...
Before submitting though, please read the information under
 ``\hyperlink{ssec:different_versions_of_submission_api}{\nameref{ssec:different_versions_of_submission_api}}''.
...
\hypertarget{ssec:different_versions_of_submission_api}{}
