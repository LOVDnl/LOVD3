...
If you have more data that you'd like to submit using this format,
 please \hyperlink{http://www.LOVD.nl/3.0/contact?question}{contact us}.
...
To make sure this doesn't harm your application, you can instruct LOVD to use an older version of the API.
