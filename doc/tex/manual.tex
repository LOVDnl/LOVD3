...
\date{2012-07-06} % I guess it's easier to use this as a "Last modified" column.
...
% TODO: add link to custom links when in manual.
  ...
  \item[Text for own disclaimer] \hfill \\
  ...
  \item[Notes for the LOVD gene homepage] \hfill \\
  ...
  \item[Notes for the variant listings] \hfill \\
