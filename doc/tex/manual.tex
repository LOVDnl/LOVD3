...
\chapter{View and search data in a LOVD installation}
To navigate in an LOVD installation you can use the tabs on the top of the page. 
Which tabs you can see depends on if you are logged in or not and when you logged in on your user level.
When you are not logged in or you are logged in as a submitter you can see the tabs Genes, Transcripts, Variants, Individuals, Diseases, Screening, Submit and Documentation.
On top of that, curators, managers and admin can see the tab Configuration and only managers and admin can see the Users and Setup tab. 

Each tab does have a dropdown menu and the tab itself does have a default page to which you will go when you click on the tab.
The content of this dropdown menu depends on what your user level is.
...
For example in the all genes view you can search for ``AAM''. 
...
\begin{figure}[ht]
  ...
  \caption{
    Results when searching for gene containing ``AAM''. 
    Note that the search is case insensetive, so ``aam'' gives the same result.
    The up and down arrow next to the column name can be used to sort the data.}
  \end{shaded}
\end{figure}
...
\begin{tabular}{>{\bfseries}p{2.3cm} p{2.3cm} p{10.7cm}}
  ...
  | & AM|DA & This gives results where either AM or DA occures.\\ \hline
  ...
  > & >23 & Filter for values higher than 23\\ \hline
  < & <23 & Filter for values lower than 23\\ \hline
\end{tabular}

\newpage
\section{Genes}
\begin{wrapfigure}[10]{r}{8cm} % Only wrap for 3 lines
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{gene_menu.png}}\centering
  		\caption[]{
  			Gene menu.}
	\end{shaded}
\end{wrapfigure}

When no gene is selected in the header, the default page of the genes tab is the view all genes page.
When a gene is selected in the header the default page of the gene tab is the gene homepage. 


\textbf{View all genes}: 
Here you can see all the genes for this installation. 
You can click on a gene to go to the View gene homepage.

\textbf{View gene homepage}: 
Here you can see the details of a gene. See for more information: \hyperlink{sec:gene_homepage}{\nameref{sec:gene_homepage}}.
This menu item is not available when no gene is selected in the header.

\textbf{View graphs for a gene}: 
This displays the statistics of the variants within a gene. 
This menu item is not available when no gene is selected in the header.

\textbf{Create a new gene entry}: 
This menu item is only available for user with user level managers or higher.
See section \hyperlink{sec:gene_create}{\nameref{sec:gene_create}} on how to add a new gene.

\section{Transcripts}
\begin{wrapfigure}[9]{l}{8cm} % Only wrap for 3 lines
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{transcript_menu.png}}\centering
  		\caption[]{
  			Transcript menu.}
	\end{shaded}
\end{wrapfigure}
When no gene is selected in the header, the default page of the transcripts tab is the view all transcripts page.
When a gene is selected in the header the default page of the transcript tab is the view all transcripts of a gene. 

\textbf{View all transcripts} and \textbf{View all transcripts of a gene} are both views which list the transcripts. In both views you can click on a transcript to view the detail of this transcript on the View transcript page. 
The view all transcripts of a gene menu item is not available when no gene is selected in the header.

\textbf{Create a new transcript information entry}: 
Create a new transcript information entry is only available for curators or higher.
See section \hyperlink{sec:transcript_create}{\nameref{sec:transcript_create}} on how to add a new transcript to a gene.

\textbf{View transcript page}: 
To get to the view transcript page you have to select a transcript in the view all transcript page or the view all transcript of a gene page. 
On this page you can find details about the transcript and below the transcript details are all variants found on the transcript. 
You can click on a variant in the variant list, this will bring you to the view genomic variant page.
...
\section{Variants}
When no gene is selected in the header, the default page of the variants tab is the view all genomic variants page.
When a gene is selected in the header the default page of the variants tab is the view unique variants in a gene. 

\textbf{View all genomic variants}:
This list view displays all genomic variants in this LOVD installation.
You can click on a variant, this will bring you to the view genomic variant page.

\textbf{View all variants affecting transcripts}:
This view displays all variants in this LOVD installation found on a transcript.
You can click on the a variant, this will bring you to the view genomic variant page.

\begin{wrapfigure}[16]{r}{8cm}
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{variant_menu.png}}\centering
  		\caption[]{
  			Variants menu.}
	\end{shaded}
\end{wrapfigure}

\textbf{View unique variants in a gene}:
This list view displays the unique variants for a gene. The number of times a variant is found is displayed in the field ``reported''.
The information in other fields are summarised and not all information for the variants are displayed.
Click on a row to see all reported items of a variant.
This menu item is not available when no gene is selected in the header.

\textbf{View all variants in a gene}:
List view of all reported variants for a gene. Same variants are not grouped as done in the unique variant view.
This menu item is not available when no gene is selected in the header.

\textbf{Full data view for a gene}:
This menu item is not available when no gene is selected in the header.

\textbf{Create a new data submission}:
Create a new gene entry is only availabile for submitters and higher. 
See chapter \hyperlink{chap:add_data}{\nameref{chap:add_data}} on how to create a new data submission.

\textbf{View active genomic custom columns} and \textbf{Enable more genomic custom columns}:
This menu item is only available for users with user level curator or higher. 
See section \hyperlink{sec:enabling_custom_columns}{\nameref{sec:enabling_custom_columns}} how to enable custom columns.

\textbf{View genomic variant page}:
To get to the view genomic variant page you have to select a variant in one of the variant list view. 
In the detail view of a genomic variant you can see which variant on transcripts are found and which screening is used.
...
\section{Individuals}
When no gene is selected in the header, the default page of the individuals tab is the view all individuals page.
When a gene is selected in the header the default page of the individuals tab is the view all individuals with variants in a gene. 

\begin{wrapfigure}[12]{l}{8cm}
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{individual_menu.png}}\centering
  		\caption[]{
  			Individuals menu.}
	\end{shaded}
\end{wrapfigure}

\textbf{View all individuals}:
All individuals in the database are displayed and can be searched. 
When you click on a individual row you will go to the detail view of the selected individual.

\textbf{View all individuals with variants in a gene}:
This view displays all individuals with variants for current selected gene. 
When you click on a individual row you will go to the detail view of the selected individual.
This menu item is not available when no gene is selected in the header.
...
\textbf{View active custom columns} and \textbf{Enable more custom columns}:
This menu item is only available for users with user level curator or higher. 
See section \hyperlink{sec:enabling_custom_columns}{\nameref{sec:enabling_custom_columns}} how to enable custom columns.

\textbf{View individual page}:
This is the detail view of a individual.
The top gives details about the individual. 
below the details the phenotype of the individual, the screenings used and the variants found in this individual are displayed.
...
\section{Diseases}
When no gene is selected in the header, the default page of the diseases tab is the view all diseases page.
When a gene is selected in the header the default page of the diseases tab is the view all diseases associated with a gene. 

\begin{wrapfigure}[10]{r}{8cm}
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{disease_menu.png}}\centering
  		\caption[]{
  			Diseases menu.}
	\end{shaded}
\end{wrapfigure}

\textbf{View all diseases}:
This page displays all the diseases in the database.
Also the number of individuals reported with this disease is displayed and the number of phenotypes reported.
When you click on a disease row you will go to the detail view of a disease.

\textbf{View all diseases associated with a gene}:
This page displays all the diseases which are associated with a gene.
Also the number of individuals reported with this disease is displayed and the number of phenotypes reported.
When you click on a disease row you will go to the detail view of a disease.
...
\textbf{View available phenotype columns}:
This menu item is only available for users with user level curator or higher.
See chapter \hyperlink{chap:custom_columns}{\nameref{chap:custom_columns}} about custom columns.

\textbf{View disease page}:
This is the detail view of a disease.
On top you can see some characteristics of the disease.
Below you can see a list view of all individuals diagnosed with current disease.




\section{Screening}
When no gene is selected in the header, the default page of the screenings tab is the view screenings page.
When a gene is selected in the header the default page of the screenings tab is the view screenings that screened for a gene.

\begin{wrapfigure}[12]{l}{8cm}
  \vspace{-25pt}
	\begin{shaded}
  		\frame{\includegraphics[width=0.95\linewidth]{screening_menu.png}}\centering
  		\caption[]{
  			Screenings menu.}
	\end{shaded}
\end{wrapfigure}
...
\textbf{View all screenings}:
All screenings in the database are displayed and can be searched.
When you click on a screening row you will go to the detail view of the selected screening.

\textbf{View all screenings for a gene}:
This view displays all screenings that screened current selected gene.
When you click on a screening row you will go to the detail view of the selected screening.
This menu item is not available when no gene is selected in the header.
...
\textbf{View screening page}:
This is the detail view of a screening.
The top gives details about the screening.
Below a list view of all genes screened with current screening and a list view of all variants found with current screening.
